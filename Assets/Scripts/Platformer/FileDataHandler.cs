...
public class FileDataHandler
{
    ...
    public GameStateInfo Load(string profileId, bool allowRestoreFromBackup = true)
    {
        ...
        if (File.Exists(fullPath))
        {
            try
            {
                ...
                loadedData = JsonUtility.FromJson<GameStateInfo>(dataToLoad);
            }
            catch (Exception e)
            {
    ...
    public void Save(GameStateInfo data, string profileId)
    {
        // base case - if the profileId is null, return right away
        if (profileId == null)
        {
        ...
        try
        {
            ...
            GameStateInfo verifiedGameData = Load(profileId);
    ...
    public Dictionary<string, GameStateInfo> LoadAllProfiles()
    {
        Dictionary<string, GameStateInfo> profileDictionary = new Dictionary<string, GameStateInfo>();
        ...
        foreach (DirectoryInfo dirInfo in dirInfos)
        {
            ...
            GameStateInfo profileData = Load(profileId);
    ...
    public string GetMostRecentlyUpdatedProfileId()
    {
        ...
        Dictionary<string, GameStateInfo> profilesGameData = LoadAllProfiles();
        foreach (KeyValuePair<string, GameStateInfo> pair in profilesGameData)
        {
            string profileId = pair.Key;
            GameStateInfo gameData = pair.Value;
